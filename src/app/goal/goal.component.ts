...
export class GoalComponent implements OnInit {
  ...
  goals = [
    ...
    new Goal(6,'Plot my world domination plan','Cause I am evil overlord',new Date (2019,3,14)),
  ]
  addNewGoal(goal){
  ...
  deleteGoal(isComplete,index){
    if(isComplete){
      let toDelete=confirm(`Are you sure want to delete ${this.goals[index].name}`)
